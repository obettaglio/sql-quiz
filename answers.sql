...
SELECT first_name, last_name, email FROM salespeople WHERE region LIKE 'Northw%';
...
SELECT email, first_name, last_name FROM salespeople WHERE region LIKE '%west%' AND last_name LIKE 'M%';
